...
--  Ada Generator: https://ada-gen.googlecode.com/svn/trunk Revision 126
-----------------------------------------------------------------------
...
private
   ...
   Null_Sequence : constant Sequence_Ref
      := Sequence_Ref'(ADO.Objects.Object_Ref with others => <>);
   ...
   Null_Entity_Type : constant Entity_Type_Ref
      := Entity_Type_Ref'(ADO.Objects.Object_Ref with others => <>);
