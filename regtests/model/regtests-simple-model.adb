...
package body Regtests.Simple.Model is
   ...
   function Allocate_Ref_Key (Id : in ADO.Identifier) return ADO.Objects.Object_Key is
      Result : ADO.Objects.Object_Key (Of_Type  => ADO.Objects.KEY_INTEGER,
                                       Of_Class => ALLOCATE_REF_TABLE'Access);
   begin
      ADO.Objects.Set_Value (Result, Id);
      return Result;
   end Allocate_Ref_Key;
   function Allocate_Ref_Key (Id : in String) return ADO.Objects.Object_Key is
      Result : ADO.Objects.Object_Key (Of_Type  => ADO.Objects.KEY_INTEGER,
                                       Of_Class => ALLOCATE_REF_TABLE'Access);
   begin
      ADO.Objects.Set_Value (Result, Id);
   ...
   function "=" (Left, Right : Allocate_Ref_Ref'Class) return Boolean is
   begin
      return ADO.Objects.Object_Ref'Class (Left) = ADO.Objects.Object_Ref'Class (Right);
   end "=";
   ...
   --  Internal method to allocate the Object_Record instance
   procedure Allocate (Object : in out Allocate_Ref_Ref) is
   ...
   function Get_Object_Version (Object : in Allocate_Ref_Ref)
                  return Integer is
   ...
   --  Copy of the object.
   function Copy (Object : Allocate_Ref_Ref) return Allocate_Ref_Ref is
      Result : Allocate_Ref_Ref;
   begin
      if not Object.Is_Null then
         declare
